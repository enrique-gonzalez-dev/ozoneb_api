class Api::V1::SkuCodesController < ApplicationController
  before_action :authenticate_user!
  before_action :check_admin_or_supervisor

  def index
    items = apply_filters(SkuCode)
    ...
    render json: {
      sku_codes: ActiveModelSerializers::SerializableResource.new(
        paginated, 
        each_serializer: Api::V1::SkuCodeSerializer,
